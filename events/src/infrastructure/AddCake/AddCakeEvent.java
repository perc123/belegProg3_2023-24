...
public class AddCakeEvent extends EventObject {
     ...
     */
    public AddCakeEvent(Object source, String kuchentyp, String hersteller, String allergene, String preis, String naehrwert, String haltbarkeit, String sorte, String... sorteZwei) {
        super(source);
    ...
    public String getSorteZwei() {
        return String.valueOf(sorteZwei);
    }
